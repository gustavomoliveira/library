...
import dev.gustavo.finesapi.domain.fine.FineBusinessException;
import dev.gustavo.finesapi.exception.BusinessException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(FineBusinessException.class)
    public ResponseEntity<ErrorResponse> handleFineBusinessException(FineBusinessException e) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ErrorResponse(HttpStatus.BAD_REQUEST.value(), e.getMessage(), LocalDateTime.now()));
    }
}